...
**对应 industry md**: [Oil_Soap_Candle_Industry_Design.md](../industries/Oil_Soap_Candle_Industry_Design.md)（蜡烛/油灯部分） + PROCESS_CHAIN §工艺品+宝石
**era**: C → R
**主要 tags**: workshop, crafts, carving, lathe, casting, inlay, jewel, candle, art

> 合并来源:
> - `../industries/CHATGPT_PROCESS_CHAIN_SOURCE.md §工艺品+宝石工坊（合并版）`（DF Craftsdwarf + Jeweler 整合）
...
**与 industry md 边界**: 详细历史脉络（Castile / Marseille / Aleppo 皂 + chandler guild 社会标签）见 [Oil_Soap_Candle_Industry_Design.md](../industries/Oil_Soap_Candle_Industry_Design.md)。
...
- 蜡烛 / 油灯历史 + 平衡: [Oil_Soap_Candle_Industry_Design.md](../industries/Oil_Soap_Candle_Industry_Design.md)
- 工艺品 / 宝石主要来源: `../industries/CHATGPT_PROCESS_CHAIN_SOURCE.md §工艺品+宝石工坊（合并版）`（已并入本文档）
