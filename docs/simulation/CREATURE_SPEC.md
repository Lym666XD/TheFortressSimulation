...
- Creature definitions are loaded as core content and attached to the world creature manager during fortress session content loading.
- Runtime creature spawn and mutation should go through Runtime command targets and diff/applicator seams where available.
- The detailed body-plan, combat, wounds, equipment coverage, cognition, and AI semantics below are target/domain design, not complete current gameplay.
