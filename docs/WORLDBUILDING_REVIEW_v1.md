...
| 新大陆胭脂虫 cochineal | 纺织 | 1520+ 西班牙引入 | R | **已决议（2026-05）：删除 cochineal**，红色染料统一使用 kermes（地中海产）+ 茜草；纺织文档已同步更新 |
...
1. ~~**越界冲突**: 农业声明的"不引入哥伦布作物"vs 纺织 R 期的 cochineal~~ → **已解决（2026-05）：删除 cochineal**
