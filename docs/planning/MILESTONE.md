...
Content Build Pipeline -> future `.cpack` target (current implementation loads JSON registries/catalogs directly); hot-reload seam.
...
Phase E — Creatures, Items, Stockpiles, Zones,orders (Weeks 9-10)
