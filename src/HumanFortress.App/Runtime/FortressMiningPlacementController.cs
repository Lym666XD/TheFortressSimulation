...
internal static class FortressMiningPlacementController
{
        ...
        Point worldPos)
    {
        ...
        if (ui.PlaceFirstCorner.HasValue && clampedWorldPos != ui.PlaceFirstCorner.Value)
        {
            ...
            var simAction = FortressPlacementCommandFactory.ToSimulationMiningAction(uiAction);
            ...
            context.Runtime.EnqueueCurrentTickCommand(FortressPlacementCommandFactory.CreateAdvancedMiningOrder(
                rect,
                zMin,
                zMax,
                uiAction,
