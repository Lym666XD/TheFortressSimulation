...
internal sealed class WorldMapGameState : ScreenGameState<WorldMapState>
{
    private readonly IAppStateNavigator _navigator;
    private readonly FortressSessionContext _session;

    internal WorldMapGameState(
    ...
    internal override GameStateType Type => GameStateType.WorldMap;

    protected override WorldMapState CreateScreen()
    {
        return new WorldMapState(_navigator, _session);
    }
}
