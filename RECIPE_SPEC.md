...
Scheduling: The job scheduler batches identical recipes to reduce overhead and ensure deterministic inputs_or choice ordering (see JOB_SCHEDULER_SPEC.md).
