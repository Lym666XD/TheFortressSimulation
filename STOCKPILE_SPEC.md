...
This document is normative. Any implementation must preserve determinism, respect UPDATE_ORDER stages, and maintain compatibility with HAULING_POLICY and JOB_SCHEDULER_SPEC.